...
func TestCityIndex_Nearest_HitOnSmallAndAttractToLarge(t *testing.T) {
	...
	expected := []string{
		"8824c5cc: CityRecord<ID=[4989005] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Clawson] POP=(12015) LAT=(42.5333700000) LON=(-83.1463200000)>",
		"8824c5d: CityRecord<ID=[4989005] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Clawson] POP=(12015) LAT=(42.5333700000) LON=(-83.1463200000)>",
		"8824c5c: CityRecord<ID=[4989005] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Clawson] POP=(12015) LAT=(42.5333700000) LON=(-83.1463200000)>",
		"8824c5: CityRecord<ID=[4989005] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Clawson] POP=(12015) LAT=(42.5333700000) LON=(-83.1463200000)>",
		"8824c4: CityRecord<ID=[5012639] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Troy] POP=(83280) LAT=(42.6055900000) LON=(-83.1499300000)>",
		"8824d: CityRecord<ID=[5014051] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Warren] POP=(134056) LAT=(42.4904400000) LON=(-83.0130400000)>",
		"8824c: CityRecord<ID=[5014051] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Warren] POP=(134056) LAT=(42.4904400000) LON=(-83.0130400000)>",
	}
...
func TestCityIndex_Nearest_NearSmallAndNotNearLarge(t *testing.T) {
	...
	expected := []string{
		"883d73: CityRecord<ID=[4996107] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Hillsdale] POP=(8163) LAT=(41.9200500000) LON=(-84.6305100000)>",
		"883d74: CityRecord<ID=[4996107] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Hillsdale] POP=(8163) LAT=(41.9200500000) LON=(-84.6305100000)>",
		"883d7: CityRecord<ID=[4996107] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Hillsdale] POP=(8163) LAT=(41.9200500000) LON=(-84.6305100000)>",
		"883d4: CityRecord<ID=[4997384] COUNTRY=[United States] PROVINCE-OR-STATE=[MI] CITY=[Jackson] POP=(33133) LAT=(42.2458700000) LON=(-84.4013500000)>",
	}
